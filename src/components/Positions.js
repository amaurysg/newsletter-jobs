...
export default function Positions() {
  return (
    <div className="px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center"><h2 class="text-base text-indigo-600 font-semibold tracking-wide uppercase">Positions</h2><p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">Look here your best job options</p></div>

      {

        Jobs.map((job, i) => {
          return (
            <div className="lg:flex lg:items-center lg:justify-between max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">

              <div className="flex-1 min-w-0 my-5">
